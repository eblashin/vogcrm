...
Процедура ПослеФормирования(Результат, ЗагрузитьРезультатФормированияОтчета) Экспорт 
	...
	ОтчетТабличныйДокумент.ФиксацияСлева = 1;
...
Процедура ЗагрузитьНастройкиВКомпоновщик(ПараметрыЗагрузки)
	...
	// +++ VOG Кулаков П.Л. 27.11.2020 CRM-1084
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(Отчет.КомпоновщикНастроек, "СтатусТТ", СтатусТТКлассификатор);
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(Отчет.КомпоновщикНастроек, "СтатусЗакрыт", СтатусТТЗакрыт);
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(Отчет.КомпоновщикНастроек, "DIYПолка", DIYПолка);
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(Отчет.КомпоновщикНастроек, "ОборудованиеКлиента", ОборудованиеКлиента);
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(Отчет.КомпоновщикНастроек, "Cersanit", Cersanit);
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(Отчет.КомпоновщикНастроек, "Cersanit2017", Cersanit2017);
	
	ТекущийПользователь = Пользователи.ТекущийПользователь();
	ПодразделениеПользователя = ТекущийПользователь.Подразделение;
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(Отчет.КомпоновщикНастроек, "ПодразделениеПользователя", Справочники.СтруктураПредприятия.ПолучитьОбособленноеПодразделение(ПодразделениеПользователя));
	
	ЭтоПолноправныйПользователь = Пользователи.ЭтоПолноправныйПользователь(ТекущийПользователь);
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(Отчет.КомпоновщикНастроек, "ЭтоПолноправныйПользователь", ЭтоПолноправныйПользователь);
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(Отчет.КомпоновщикНастроек, "ЭтоДТН", ЭтоДТН);
	
	ДоступККлиентскойБазе = Пользователи.РолиДоступны("вогПолныйДоступККлиентскойБазеЧтение",ТекущийПользователь);
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(Отчет.КомпоновщикНастроек, "ДоступККлиентскойБазе", ДоступККлиентскойБазе);
	
	ПользовательскиеНастройкиКомпоновки = Отчет.КомпоновщикНастроек.ПользовательскиеНастройки;
