...
Процедура НастроитьВариантыОтчета(Настройки, ОписаниеОтчета) Экспорт
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ДистрибуцияТорговыхТочекИнтернетМагазин");
	ОписаниеВарианта.Описание = НСтр("ru = 'Дистрибуция торговых точек (интернет-магазин)'");
