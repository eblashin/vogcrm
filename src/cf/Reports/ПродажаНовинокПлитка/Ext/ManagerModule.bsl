...
Процедура НастроитьВариантыОтчета(Настройки, ОписаниеОтчета) Экспорт
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ПродажиНовинок");
	ОписаниеВарианта.Описание = НСтр("ru = 'Продажа новинок 2021 (плитка)'");
