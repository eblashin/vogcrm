...
Процедура НастроитьВариантыОтчета(Настройки, ОписаниеОтчета) Экспорт
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ПланированиеПродажГодовое");
	ОписаниеВарианта.Описание = НСтр("ru = 'Планирование продаж годовое (плитка)'");
