...
Процедура ПриЗагрузкеПользовательскихНастроекНаСервере(НовыеПользовательскиеНастройкиКД)
	...
	ЕстьРольМенеджер				= РолиПользователя.Найти(Справочники.РолиИсполнителей.ПолучитьСсылку(Новый УникальныйИдентификатор("2403e82e-cad9-11e8-a684-005056bc3fe8")));
	ЕстьРольКоординатор 			= РолиПользователя.Найти(Справочники.РолиИсполнителей.ПолучитьСсылку(Новый УникальныйИдентификатор("21bee87e-caef-11e8-a684-005056bc3fe8")));
	
	КомпоновщикНастроек = Отчет.КомпоновщикНастроек;
	
	Если ЕстьРольМенеджер <> Неопределено ИЛИ ЕстьРольКоординатор <> Неопределено Тогда
