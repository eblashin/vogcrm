...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//СписокСтатусов.Добавить(СтатусАКБ);
	//СписокСтатусов.Добавить(СтатусНАКБ);
	//СписокСтатусов.Добавить(СтатусНовая);
	//СписокСтатусов.Добавить(СтатусЗакрыт);
	//
	//Для каждого ЭлементОтбора из ОтчетОбъект.КомпоновщикНастроек.Настройки.Отбор.Элементы цикл
	//	Если ЭлементОтбора.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("СтатусТТ") тогда
	//		ИД = ЭлементОтбора.ИдентификаторПользовательскойНастройки; 	
	//	КонецЕсли;
	//КонецЦикла;
	//ПользовательскийОтбор = ОтчетОбъект.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы.Найти(ИД);
	//ПользовательскийОтбор.ПравоеЗначение = СписокСтатусов;
