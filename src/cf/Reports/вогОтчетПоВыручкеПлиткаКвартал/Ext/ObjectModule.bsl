...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	//ПараметрСегментНГ = КомпоновкаДанныхКлиентСервер.ПолучитьПараметр(КомпоновщикНастроек, "СегментНГОтбор");
	...
	//Если Не ЗначениеЗаполнено(ПараметрСегментНГ.Значение) Тогда
		//ПараметрСегментНГ.Значение = СегментНГ;
	//КонецЕсли;
	...
	// +++ VOG Кулаков П.Л. 29.07.2021 DEV-579
	Если КомпоновщикНастроек.Настройки.ДополнительныеСвойства.КлючВарианта = "ТранспортныеРасходы" Тогда
		ОтборЭконом = Истина;
	КонецЕсли;
	// --- VOG Кулаков П.Л.
	...
	УстанавливаемыеПараметры.Вставить("СценарийПланаПродаж", 			Справочники.вогСценарииПланирования.ПланНаГод);
	...
	//УстанавливаемыеПараметры.Вставить("НакопительныйИтог", 				КомпоновщикНастроек.Настройки.ДополнительныеСвойства.КлючВарианта = "Основной1");
	//УстанавливаемыеПараметры.Вставить("НачалоМесяца", 					НачалоМесяца(ДатаОтчета));
	//УстанавливаемыеПараметры.Вставить("СценарийПланНаМесяц", 			Справочники.вогСценарииПланирования.ПланНаМесяцПоКлиентам);
	
	УстанавливаемыеПараметры.Вставить("СегментНГОтбор", 				СегментНГ);
