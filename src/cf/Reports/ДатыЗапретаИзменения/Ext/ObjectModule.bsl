...
Функция ТекстЗапроса()
	...
	|			И ДатыЗапрета.Объект = ДатыЗапретаИзменения.Объект
	|ГДЕ
	|	НЕ(НЕ ЛОЖЬ В (&ЗаданныеРазделы)
	|				И ДатыЗапрета.Раздел <> ЗНАЧЕНИЕ(ПланВидовХарактеристик.РазделыДатЗапретаИзменения.ПустаяСсылка)
	|				И НЕ ДатыЗапрета.Раздел В (&ЗаданныеРазделы))
	|	И НЕ(НЕ ЛОЖЬ В (&ЗаданныеОбъекты)
	|				И ДатыЗапрета.Объект <> ДатыЗапрета.Раздел
	|				И НЕ ДатыЗапрета.Объект В (&ЗаданныеОбъекты))";
