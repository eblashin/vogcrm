...
Процедура НастроитьВариантыОтчета(Настройки, ОписаниеОтчета) Экспорт
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ПланФактПоКомандировкам");
	ОписаниеВарианта.Описание = НСтр("ru = 'План-факт по командировкам'");
