...
Процедура НастроитьВариантыОтчета(Настройки, ОписаниеОтчета) Экспорт
	...
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ДистрибуцияТорговыхТочекПлитка");
	ОписаниеВарианта.Описание = НСтр("ru = 'Дистрибуция торговых точек (Плитка)'");
