...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не РольДоступнаДобавлениеИзменениеОбменовДанными Или ОбщегоНазначения.РазделениеВключено() Тогда
...
Процедура СписокСостоянияУзловПриАктивизацииСтроки(Элемент)
	...
	ПодключитьОбработчикОжидания("Подключаемый_СписокСостоянияУзловПриАктивизацииСтроки", 0.1, Истина);
...
&НаКлиенте
Процедура Подключаемый_СписокСостоянияУзловПриАктивизацииСтроки() Экспорт
