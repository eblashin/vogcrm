...
Функция сфпПолучитьКлючЗаписи(Пользователь)
	...
	СтруктураОтбора.Вставить("Настройка",		ПланыВидовХарактеристик.CRM_НастройкиПользователей.сфпТекущийВнутреннийНомер);
	Возврат РегистрыСведений.CRM_НастройкиПользователей.СоздатьКлючЗаписи(СтруктураОтбора);
