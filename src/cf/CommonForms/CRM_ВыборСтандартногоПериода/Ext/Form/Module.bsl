...
Процедура ВыбратьМесяц(НомерМесяца)
	...
	ВыполнитьВыборПериода(ПредопределенноеЗначение("Перечисление.Периодичность.Месяц"));
...
Процедура ВыбратьКвартал(НомерКвартала)
	...
	ВыполнитьВыборПериода(ПредопределенноеЗначение("Перечисление.Периодичность.Квартал"));
