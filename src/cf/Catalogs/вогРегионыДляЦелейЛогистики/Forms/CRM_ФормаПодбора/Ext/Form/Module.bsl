...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МакетКлассификатор = Справочники.вогРегионыДляЦелейЛогистики.ПолучитьМакет("CRM_Классификатор");
...
Процедура ДобавитьРегионВСправочникПоКоду(КодРегиона)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ИЗ
	               |	Справочник.вогРегионыДляЦелейЛогистики КАК БизнесРегионы
	               |ГДЕ
	...
	Для Каждого ЭлементМассиваКодов Из МассивКодовРегионов Цикл
		...
		Если СтрокаРегиона = Неопределено Тогда
			...
			НовыйРегионОбъект = Справочники.вогРегионыДляЦелейЛогистики.СоздатьЭлемент();
