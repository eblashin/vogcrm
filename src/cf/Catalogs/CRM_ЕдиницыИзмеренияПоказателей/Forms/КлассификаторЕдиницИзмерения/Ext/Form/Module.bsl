...
Процедура ОбработатьРезультатыПодбораНаСервере()
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	CRM_ЕдиницыИзмеренияПоказателей.Ссылка КАК Ссылка,
	|	CRM_ЕдиницыИзмеренияПоказателей.Код КАК Код
	|ИЗ
	|	Справочник.CRM_ЕдиницыИзмеренияПоказателей КАК CRM_ЕдиницыИзмеренияПоказателей
	|ГДЕ
	|	CRM_ЕдиницыИзмеренияПоказателей.Код В(&МассивКодов)";
	...
	Для каждого СтрокаДерева Из МассивВыбранныхСтрок Цикл
		...
		Иначе
			СправочникОбъект = Справочники.CRM_ЕдиницыИзмеренияПоказателей.СоздатьЭлемент();
		КонецЕсли;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Макет = Справочники.CRM_ЕдиницыИзмеренияПоказателей.ПолучитьМакет("КлассификаторЕдиницИзмерения");
