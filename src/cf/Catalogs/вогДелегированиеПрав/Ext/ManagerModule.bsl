...
Функция ПолучитьДелегатовДляУведомления(Подписчик, Объект) Экспорт
	...
	|	И ДелегированиеПрав.ВариантДелегирования = ЗНАЧЕНИЕ(Перечисление.вогВариантыДелегированияПрав.ВсеПрава)
	|
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|ИЗ
	|	Справочник.вогДелегированиеПрав.ОбластиДелегирования КАК ДелегированиеПравОбластиДелегирования
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.вогОбластиДелегированияПрав.Состав КАК ОбластиДелегированияПравСостав
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.вогДелегированиеПрав КАК ДелегированиеПрав
	|		ПО ДелегированиеПравОбластиДелегирования.Ссылка = ДелегированиеПрав.Ссылка
	|ГДЕ
	|	ДелегированиеПрав.ОтКого = &Подписчик
	|	И ДелегированиеПрав.Действует
	|	И ДелегированиеПрав.ВариантДелегирования = ЗНАЧЕНИЕ(Перечисление.вогВариантыДелегированияПрав.Выборочно)";
