...
Функция ПочтовыеАдресаПолучателя(Получатель, СписокЗначений)
	...
	Попытка
		ПочтовыеАдреса = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъектов(Получатели, ТипыКонтактнойИнформации);
	Исключение
...
Процедура СобытияРассылки()
	ПараметрыФормыЖурналаРегистрации = ПараметрыФормыЖурналаРегистрации(Объект.Ссылка);
