...
Процедура ЗаполнитьСоставОбъектов()
	...
	Запрос = Новый Запрос(
		...
		|ИЗ
		|	Справочник.вогОбластиДелегированияПрав.Состав КАК ОбластиДелегированияПравСостав
	...
	ДеревоМетаданных = вогОбщегоНазначения.ДеревоМетаданныхКонфигурации(Отбор);
