...
Функция ПолучитьСтруктуруСклонения(Именительный) Экспорт
	//+++ Терпогосян Д.Б. [06.08.2021 9:57:22] № DEV-813
	лСтруктураСклонения = Неопределено; 
	СклонениеПредставленийОбъектовВызовСервера.ПросклонятьПредставлениеПоВсемПадежам(Именительный, лСтруктураСклонения);
	
	СтруктураСклонения = Новый Структура("Именительный, Родительный, Дательный, Винительный, Творительный, Предложный");
	//СтруктураСклонения.Именительный	= Именительный;
	//СтруктураСклонения.Родительный 	= daСклонение(Именительный, "Р");
	//СтруктураСклонения.Дательный 	= daСклонение(Именительный, "Д");
	//СтруктураСклонения.Винительный 	= daСклонение(Именительный, "В");
	//СтруктураСклонения.Творительный	= daСклонение(Именительный, "Т");
	//СтруктураСклонения.Предложный 	= daСклонение(Именительный, "П");
	
	СтруктураСклонения.Именительный	= лСтруктураСклонения.ИменительныйПадеж;
	СтруктураСклонения.Родительный 	= лСтруктураСклонения.РодительныйПадеж;
	СтруктураСклонения.Дательный 	= лСтруктураСклонения.ДательныйПадеж;
	СтруктураСклонения.Винительный 	= лСтруктураСклонения.ВинительныйПадеж;
	СтруктураСклонения.Творительный	= лСтруктураСклонения.ТворительныйПадеж;
	СтруктураСклонения.Предложный 	= лСтруктураСклонения.ПредложныйПадеж;
	Возврат СтруктураСклонения;
	//--- Терпогосян Д.Б. [06.08.2021 9:57:28] № DEV-813 
...
//
Функция daСклонение(_Выражение, _Падеж = "И", _Род = "", _Режим = "Д", _ФорматнаяСтрока = "") экспорт
