	...
	Попытка
		Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
			...
			Если Первое Тогда
				...
				ВзаимодействиеОбъект.СостояниеИнтереса = Справочники.CRM_СостоянияИнтересов.ИнтересПотерян;
				...
				ВзаимодействиеОбъект.ОжидаемаяВыручка = Интерес.ОжидаемаяВыручка;
		...
		ИнтересОбъект.СостояниеИнтереса = Справочники.CRM_СостоянияИнтересов.ИнтересПотерян;
