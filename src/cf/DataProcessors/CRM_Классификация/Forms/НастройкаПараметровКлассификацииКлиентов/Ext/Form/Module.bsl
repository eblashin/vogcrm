...
Процедура ПриОткрытии(Отказ)
	...
	Элементы.ДекорацияABCКлассификацияОписание.Заголовок = НСтр("ru = 'По данным за период: '") + ПолучитьОписаниеНастройки(ПериодABCКлассификации, КоличествоПериодовABCКлассификации);
	Элементы.ДекорацияXYZКлассификацияОписание.Заголовок = НСтр("ru = 'По данным за период: '") + ПолучитьОписаниеНастройки(ПериодXYZКлассификации, КоличествоПериодовXYZКлассификации, ПодпериодXYZКлассификации);
