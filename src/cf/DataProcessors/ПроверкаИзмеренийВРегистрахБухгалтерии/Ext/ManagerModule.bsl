...
//
// Параметры:
//   Сведения - Структура - описание см. РаботаВБезопасномРежимеСлужебныйВМоделиСервиса.ПриЗаполненииПроверок()
//
...
//
// Параметры:
//   Настройки - Структура - описание см. РаботаВБезопасномРежимеСлужебныйВМоделиСервиса.ПриЗаполненииПроверок().
//   ВременныеДанные - Структура - описание см. РаботаВБезопасномРежимеСлужебныйВМоделиСервиса.ПриЗаполненииПроверок().
//   Исправлять - Булево - описание см. РаботаВБезопасномРежимеСлужебныйВМоделиСервиса.ПриЗаполненииПроверок().
//   Отказ - Булево - описание см. РаботаВБезопасномРежимеСлужебныйВМоделиСервиса.ПриЗаполненииПроверок().
//
...
//   ВременныеДанные - Структура - описание см. РаботаВБезопасномРежимеСлужебныйВМоделиСервиса.ПриЗаполненииПроверок().
//   Исправлять - Булево - описание см. РаботаВБезопасномРежимеСлужебныйВМоделиСервиса.ПриЗаполненииПроверок().
//   Результат - Структура - описание см. РаботаВБезопасномРежимеСлужебныйВМоделиСервиса.ПриЗаполненииПроверок():
//
