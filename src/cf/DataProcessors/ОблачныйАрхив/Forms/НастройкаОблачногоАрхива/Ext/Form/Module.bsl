...
Процедура ИнициализироватьРасписание()
	...
	Перем ЗаписьХМЛ, ИмяВременногоФайлаНастроекИБ, НомерНедели, СписокДнейМесяца, СписокДнейНедели, СтрокаКоманды, ТекущееРасписание, ТекущийДеньМесяца, ТекущийДеньМесяцаПредставление, ТекущийДеньНедели, ТекущийДеньНеделиПредставление;
