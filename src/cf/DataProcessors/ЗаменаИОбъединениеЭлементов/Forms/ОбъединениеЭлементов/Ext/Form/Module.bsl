...
Процедура ШагМастераДалее()
	...
	Если ТекущаяСтраница = Элементы.ШагВыборОсновногоЭлемента Тогда
		...
		Если Не ПустаяСтрока(ТекстОшибки) Тогда
			ПараметрыПредупреждения = Новый Структура("Заголовок, Текст");
			ПараметрыПредупреждения.Заголовок = НСтр("ru = 'Невозможно объединить элементы'");
			ПараметрыПредупреждения.Текст     = ТекстОшибки;
