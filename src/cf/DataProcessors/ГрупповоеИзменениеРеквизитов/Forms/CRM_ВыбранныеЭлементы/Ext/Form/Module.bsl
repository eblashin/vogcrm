...
//
Процедура CRM_ЗагрузитьИзРезультатаОтчета(Команда)
	СтруктураПараметры = Новый Структура("Режим, КомпоновщикНастроек, НеДляОтчетов", "", КомпоновщикНастроек, Истина);
	Если Не ЗначениеЗаполнено(КомпоновщикНастроек.Настройки.Отбор.ИдентификаторПользовательскойНастройки) Тогда
