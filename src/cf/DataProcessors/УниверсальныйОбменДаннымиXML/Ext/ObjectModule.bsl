...
//
// Параметры:
//  ЗначениеТипа - Строка или Тип - Содержит имя типа или значение типа Тип.
//  
// Возвращаемое значение:
...
//
// Параметры:
//  Тип          - Строка или Тип - имя типа или значение типа Тип.
//
// Возвращаемое значение:
...
//
// Параметры:
//  Менеджер       - СправочникМенеджер, ДокументМенеджер и т.д. Менеджер искомого объекта;
//  Свойство       - Строка - свойство, по которому осуществляем поиск: Имя, Код, 
//                   Наименование или Имя индексируемого реквизита.
//  Значение       - Строка, Число, Дата и т.п. Значение свойства, по которому ищем объект.
//  НайденныйОбъектПоУникальномуИдентификатору - СправочникОбъект, ДокументОбъект и т.д. Объект информационной базы, 
//                   который был найден по уникальному идентификатору в ходе выполнения функции.
//  ОбщаяСтруктураСвойств - структура, содержащая свойства искомого объекта.
//  ОбщиеСвойстваПоиска - Структура, содержащая общие свойства поиска.
//  СтрокаЗапросаПоискаПоУникальномуИдентификатору - Строка.
//
// Возвращаемое значение:
