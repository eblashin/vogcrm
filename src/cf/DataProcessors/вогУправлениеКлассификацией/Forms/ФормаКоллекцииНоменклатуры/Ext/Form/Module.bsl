...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ТипЗнч(ВыбранноеЗначение) = Тип("СправочникСсылка.вогНастройкиУправленияКлассификацией") Тогда
		ТекущаяНастройка["СписокКоллекцииНоменклатуры"] = ВыбранноеЗначение;	
...
Процедура НастроитьОтборПоКлассификаторам(Команда)
	...
	ПараметрыФормы.Вставить("Принадлежность"	 	  , "Справочник.вогКоллекцииНоменклатуры");
...
Процедура ВыбратьНастройку(Команда)
	...
	Отбор.Вставить("ИмяСписка", "СписокКоллекцииНоменклатуры");
...
Процедура СохранитьНастройку(Команда)
	...
	//Основные настройки
	ПараметрыНастройки.Вставить("ВариантСписка", ТекущийВариантСписка["СписокКоллекцииНоменклатуры"]);
	...
	ОткрытьФорму("Справочник.вогНастройкиУправленияКлассификацией.Форма.СохранениеНастройки",
		Новый Структура("ИмяСписка, Настройки", "СписокКоллекцииНоменклатуры", ПараметрыНастройки), ЭтотОбъект,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура Подключаемый_ДобавитьВариантСписка(Команда)
	...
	ЗначенияЗаполнения.Вставить("ИмяСписка", "СписокКоллекцииНоменклатуры");
...
Функция ПолучитьПараметрыСписка()
	...
	ПараметрыСписка.Вставить("ИмяСписка"      	 , "СписокКоллекцииНоменклатуры");
	ПараметрыСписка.Вставить("ОсновнаяТаблица"	 , "Справочник.вогКоллекцииНоменклатуры");
...
Процедура ИнициализироватьФормуПоНастройкеКлиент()
	...
	Настройка = ПолучитьНастройкиПоСсылке(ТекущаяНастройка["СписокКоллекцииНоменклатуры"]);
...
Процедура ИнициализироватьНастройки(Настройка)
	...
	ИмяСписка = "СписокКоллекцииНоменклатуры";
...
Процедура СформироватьЗаголовокПоНастройке(Форма)
	...
	Настройка = Форма.ТекущаяНастройка["СписокКоллекцииНоменклатуры"];
	Форма.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Коллекции номенклатуры (%1)'"), 
