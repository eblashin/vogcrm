...
Процедура ПолучитьДанные(ПараметрыЗагрузкиКлассификатора, АдресХранилища = "") Экспорт
	...
	УстановитьПривилегированныйРежим(Истина);
	ТекущаяВерсияКлассификатора = Константы.ВерсияКлассификатораБанков.Получить();
	УстановитьПривилегированныйРежим(Ложь);
	...
	Если ПараметрыПолученияФайлов["ВерсияКлассификатора"] > ТекущаяВерсияКлассификатора Тогда
		УстановитьВерсиюКлассификатораБанков(ПараметрыПолученияФайлов["ВерсияКлассификатора"]);
	КонецЕсли;
...
Процедура УстановитьВерсиюКлассификатораБанков(ДатаВерсии = "")
	...
	Если ТипЗнч(ДатаВерсии) <> Тип("Дата") Тогда
		Константы.ВерсияКлассификатораБанков.Установить(ТекущаяУниверсальнаяДата());
	Иначе
		Константы.ВерсияКлассификатораБанков.Установить(ДатаВерсии);
	КонецЕсли;
КонецПроцедуры
...
Функция КлассификаторАктуален() Экспорт
	УстановитьПривилегированныйРежим(Истина);
	ПоследнееОбновление = Константы.ВерсияКлассификатораБанков.Получить();
