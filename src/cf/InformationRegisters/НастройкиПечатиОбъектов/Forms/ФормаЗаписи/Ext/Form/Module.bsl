...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПраваПользователяПовтИсп.ДобавлениеИзменениеНастройкиПечатиОбъектов() Тогда
		...
		Если Запись.ИсходныйКлючЗаписи.Пустой() Тогда
			Запись.НаправлениеДеятельности = Неопределено;
		ИначеЕсли ЗначениеЗаполнено(Запись.НаправлениеДеятельности) Тогда
			ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаУдалить", "Видимость", Ложь);
		КонецЕсли;
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если Не ПраваПользователяПовтИсп.ДобавлениеИзменениеНастройкиПечатиОбъектов()
		И ЗначениеЗаполнено(ТекущийОбъект.НаправлениеДеятельности) Тогда
		
		Отказ = Истина;
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Нет прав на запись настройки печати по направлению деятельности'"));
...
Процедура ПриИзмененииТипаОбъектаСервер()
	...
	Элементы.НаправлениеДеятельности.Доступность = ПараметрыОбъекта.ЕстьНаправлениеДеятельности;
	...
	Если Не ПараметрыОбъекта.ЕстьНаправлениеДеятельности Тогда
		Запись.НаправлениеДеятельности = Неопределено;
	КонецЕсли;
