...
Процедура ЗаполнитьТипыОбъектовВДеревеЗначений()
	...
	Для Каждого Тип Из ТаблицаТипов Цикл
		...
		Если Не НастройкаИмеетГлобальныеПравила Тогда
			НайденныеНастройки = НастройкиСинхронизации.НайтиСтроки(Новый Структура("ВладелецФайла, ЭтоФайл", НоваяСтрокаТаблицы.ВладелецФайла, НоваяСтрокаТаблицы.ЭтоФайл));
