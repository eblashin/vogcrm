...
Процедура ИсполнителиПередУдалением(Элемент, Отказ)
	...
	//
	//Если ЗначениеЗаполнено(ТекДанные.ВременныйДоступ) Тогда
	//	ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Эта строка добавлена через временный доступ. Ручное удаление не доступно",,,, Отказ);
	//КонецЕсли;
