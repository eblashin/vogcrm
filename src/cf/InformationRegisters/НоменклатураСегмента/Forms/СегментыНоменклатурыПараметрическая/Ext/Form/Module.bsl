...
Процедура СегментыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ИначеЕсли Поле.Имя = "ОбновляемыеИДинамическиеКоличествоХарактеристик" Тогда
		...
		ОткрытьФорму("РегистрСведений.НоменклатураСегмента.Форма.ВыборХарактеристики",
			Новый Структура("ТаблицаХарактеристик,ТолькоПросмотр",ТекущиеДанные.Характеристики,Истина),,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ВключитьУдалитьВСегментКлиент(Включить)
	...
	Если ИспользуютсяХарактеристики И Включить Тогда
		...
		ОписаниеОповещения = Новый ОписаниеОповещения("ВключитьУдалитьВСегментКлиентЗавершение", ЭтотОбъект, МассивОбрабатываемыхСегментов);
		ОткрытьФорму("РегистрСведений.НоменклатураСегмента.Форма.ВыборХарактеристики",
			Новый Структура("ТаблицаХарактеристик",ХарактеристикиДляИзменения,Истина),,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
&НаКлиенте
Процедура ВключитьУдалитьВСегментКлиентЗавершение(ТаблицаРезультат, МассивОбрабатываемыхСегментов) Экспорт
