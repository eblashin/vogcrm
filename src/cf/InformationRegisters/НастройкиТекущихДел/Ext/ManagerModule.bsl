...
Функция РасположениеВиджетовПоУмолчанию()
	...
	КоличествоСтр = 3;	
	КоличествоСт = 6; // КоличествоСт = 4; VOG Ульянов И.В. 06.02.2020 CRM-239
	...
	//РасположениеВиджетов.Виджет1_4 = Справочники.Виджеты.Звонки;
	РасположениеВиджетов.Виджет1_1 = Справочники.Виджеты.МоиЗадачи;
	РасположениеВиджетов.Виджет1_2 = Справочники.Виджеты.Мероприятия;
	РасположениеВиджетов.Виджет1_3 = Справочники.Виджеты.Командировка;	
	РасположениеВиджетов.Виджет1_4 = Справочники.Виджеты.Почта;	
	РасположениеВиджетов.Виджет1_5 = Справочники.Виджеты.Звонки;	
	// -- VOG Ульянов И.В. 06.02.2020 CRM-239
