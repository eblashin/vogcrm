...
Перем мДокументыКПересчетуСостоянияОтгрузки;
...
Процедура ПриПолученииДанныхФайла(ЭлементДанных)
	...
	// +CRM
	//Если ТипПолучаемогоОбъекта = Тип("РегистрСведенийНаборЗаписей.СостоянияОтгрузки")
	//	И ПланыОбмена.ИзменениеЗарегистрировано(ЭтотОбъект.Ссылка, ЭлементДанных) Тогда
	//	
	//	ДокументОтгрузки = ЭлементДанных.Отбор.ДокументОтгрузки.Значение;
	//	
	//	Если ОбщегоНазначения.СсылкаСуществует(ДокументОтгрузки) Тогда
	//		мДокументыКПересчетуСостоянияОтгрузки.Добавить(ДокументОтгрузки);
	//	КонецЕсли;
	//	
	//ИначеЕсли ТипПолучаемогоОбъекта = Тип("СправочникОбъект.СегментыНоменклатуры")
	//	Или ТипПолучаемогоОбъекта = Тип("СправочникОбъект.СегментыПартнеров")
	//	Или ТипПолучаемогоОбъекта = Тип("СправочникОбъект.ПравилаНачисленияИСписанияБонусныхБаллов") Тогда
	Если ТипПолучаемогоОбъекта = Тип("СправочникОбъект.СегментыНоменклатуры")
		Или ТипПолучаемогоОбъекта = Тип("СправочникОбъект.СегментыПартнеров") Тогда
	// -CRM		
		...
		КонецЕсли;
	// +CRM	
	//ИначеЕсли ТипПолучаемогоОбъекта = Тип("СправочникОбъект.Склады") Тогда
	//
	//	Если Не ЭлементДанных.ЭтоГруппа Тогда
	//		
	//		РеглЗаданияЭтойИБ = ПолучитьРеглЗаданияЭтойИБ(
	//			ЭлементДанных, "РегламентноеЗаданиеСозданиеРасходныхОрдеров");
	//		
	//		Если РеглЗаданияЭтойИБ = Неопределено Тогда
	//			ЭлементДанных.СоздаватьРасходныеОрдераРегламентнымЗаданием = Ложь;
	//		Иначе
	//			ЭлементДанных.СоздаватьРасходныеОрдераРегламентнымЗаданием = 
	//				ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ЭлементДанных.Ссылка, "СоздаватьРасходныеОрдераРегламентнымЗаданием");
	//		КонецЕсли;
	//		
	//		ЭлементДанных.РегламентноеЗаданиеСозданиеРасходныхОрдеров = РеглЗаданияЭтойИБ;
	//		
	//	КонецЕсли;
	//	
...
Процедура ПослеЗагрузкиДанных()
	...
	//
	//СкладыСервер.ОтразитьСостоянияОтгрузки(мДокументыКПересчетуСостоянияОтгрузки, Ложь);
	//
...
мДокументыКПересчетуСостоянияОтгрузки = Новый Массив;
