...
Функция НастройкаОтборовНаУзлеБазыКорреспондента(ВерсияКорреспондента, ИмяФормы, ИдентификаторНастройки) Экспорт
	...
	СтруктураНастроек.Вставить("ОтправлятьВедомостиНаВыплатуЗарплаты", Истина);
...
Функция ЗначенияПоУмолчаниюНаУзлеБазыКорреспондента(ВерсияКорреспондента, ИмяФормы, ИдентификаторНастройки) Экспорт
	...
	СтруктураНастроек = Новый Структура;
	СтруктураНастроек.Вставить("ПутьКМенеджеруОбмена", "");
...
Функция ОписаниеЗначенийПоУмолчаниюБазыКорреспондента(ЗначенияПоУмолчаниюНаУзле, ВерсияКорреспондента, ИдентификаторНастройки) Экспорт
	...
	Иначе
		// Путь к менеджеру обмена
		Если ЗначениеЗаполнено(ЗначенияПоУмолчаниюНаУзле.ПутьКМенеджеруОбмена) Тогда
			ОписаниеПутьКМенеджеру = НСтр("ru = 'Указан путь к менеджеру обмена данными: ""%1"".'");
			ОписаниеПутьКМенеджеру = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ОписаниеПутьКМенеджеру, ЗначенияПоУмолчаниюНаУзле.ПутьКМенеджеруОбмена);
		Иначе
			ОписаниеПутьКМенеджеру = НСтр("ru = 'Путь к менеджеру обмена данными не указан.'");
		КонецЕсли;
		
		ШаблонОписанияЗначенийПоУмолчанию = НСтр("ru = '%1'");
		
		ОписаниеЗначенийПоУмолчанию = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонОписанияЗначенийПоУмолчанию, ОписаниеПутьКМенеджеру);
...
Процедура ОпределитьНастройки(Настройки, ИдентификаторНастройки) Экспорт
	...
	Если ИдентификаторНастройки = "ОбменCRMБП" Тогда
	...
	ИначеЕсли ИдентификаторНастройки = "ОбменCRMУТ11" Тогда
		Настройки.Вставить("ЗаголовокКомандыДляСозданияНовогоОбменаДанными", НСтр("ru = '1С:Управление торговлей, редакция 11'"));
		Настройки.Вставить("ЗаголовокПомощникаСозданияОбмена",               НСтр("ru = 'Настройка синхронизации с программой ""1С:Управление торговлей, редакция 11""'"));
		Настройки.Вставить("ЗаголовокУзлаПланаОбмена",                       НСтр("ru = 'Синхронизация с программой ""1С:Управление торговлей, редакция 11""'"));
		Настройки.Вставить("НаименованиеКонфигурацииКорреспондента",         НСтр("ru = '1С:Управление торговлей, редакция 11'"));
	ИначеЕсли ИдентификаторНастройки = "ОбменCRMУП" Тогда
	...
	ИначеЕсли ИдентификаторНастройки = "ОбменCRMКА" Тогда
		Настройки.Вставить("ЗаголовокКомандыДляСозданияНовогоОбменаДанными", НСтр("ru = '1С:Комплексная автоматизация 2.2'"));
		Настройки.Вставить("ЗаголовокПомощникаСозданияОбмена",               НСтр("ru = 'Настройка синхронизации с программой ""1С:Комплексная автоматизация 2.2""'"));
		Настройки.Вставить("ЗаголовокУзлаПланаОбмена",                       НСтр("ru = 'Синхронизация с программой ""1С:Комплексная автоматизация 2.2""'"));
		Настройки.Вставить("НаименованиеКонфигурацииКорреспондента",         НСтр("ru = '1С:Комплексная автоматизация 2.2'"));
	ИначеЕсли ИдентификаторНастройки = "ОбменCRMУНФ" Тогда
		Настройки.Вставить("ЗаголовокКомандыДляСозданияНовогоОбменаДанными", НСтр("ru = '1С:Управление небольшой фирмой 1.6'"));
		Настройки.Вставить("ЗаголовокПомощникаСозданияОбмена",               НСтр("ru = 'Настройка синхронизации с программой ""1С:Управление небольшой фирмой 1.6""'"));
		Настройки.Вставить("ЗаголовокУзлаПланаОбмена",                       НСтр("ru = 'Синхронизация с программой ""1С:Управление небольшой фирмой 1.6""'"));
		Настройки.Вставить("НаименованиеКонфигурацииКорреспондента",         НСтр("ru = '1С:Управление небольшой фирмой 1.6'"));
...
// +CRM
	ДополнительныеДанные.Вставить("ИспользоватьУчетНДС", Ложь);
	//ДополнительныеДанные.Вставить("ИспользоватьУчетНДС", ПолучитьФункциональнуюОпцию("УчитыватьНДС"));
// +CRM
...
Функция МассивДоступныхВариантовНастроекОбмена()
	...
	МассивНастроек.Добавить("ОбменCRMБП");
	МассивНастроек.Добавить("ОбменCRMУТ11");
	МассивНастроек.Добавить("ОбменCRMУП");
	МассивНастроек.Добавить("ОбменCRMКА");
	МассивНастроек.Добавить("ОбменCRMУНФ");
...
Процедура ПолучитьВерсииФорматаОбмена(ВерсииФормата) Экспорт
	...
	Если Выборка.Следующий() Тогда
		ВнешняяОбработкаМенеджераОбмена = ВнешниеОбработки.Создать(Выборка.ПутьКМенеджеруОбмена);
		ВерсииФормата.Вставить("1.0.beta", ВнешняяОбработкаМенеджераОбмена);
		ВерсииФормата.Вставить("1.0", ВнешняяОбработкаМенеджераОбмена);
		ВерсииФормата.Вставить("1.1", ВнешняяОбработкаМенеджераОбмена);
		ВерсииФормата.Вставить("1.2", ВнешняяОбработкаМенеджераОбмена);
		ВерсииФормата.Вставить("1.3", ВнешняяОбработкаМенеджераОбмена);
	Иначе
