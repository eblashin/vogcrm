...
//  ТипКонтактнойИнформации - Перечисления.ТипыКонтактнойИнформации - возможность установить отбор по типу получаемой контактной информации.
//
...
Процедура УстановитьПапкуЭлектронногоПисьма(Ссылка, Папка, РассчитыватьРассмотрено = Истина) Экспорт
	...
	ЗаписьРегистрРеквизитыВзаимодействия(Ссылка, СтруктураДляЗаписи);
...
Функция ДанныеПисьмаДляСохраненияКакФайл(Письмо, УникальныйИдентификатор) Экспорт
	...
	Если ДанныеПисьма <> Неопределено Тогда
		...
		ДанныеФайла.Наименование = ВзаимодействияКлиентСервер.ПредставлениеПисьма(ДанныеПисьма.ИнтернетПочтовоеСообщение.Тема,
