...
Функция ВнешнееСоединениеСБазой(Параметры) Экспорт
	...
	Возврат ОбменДаннымиПовтИсп.УстановитьВнешнееСоединениеСБазой(Параметры)
...
Функция РежимРегистрацииДанныхДляПланаОбменаПриОбновленииИнформационнойБазы(ИмяПланаОбмена) Экспорт
	...
	Возврат ОбменДаннымиПовтИсп.РежимРегистрацииДанныхДляПланаОбменаПриОбновленииИнформационнойБазы(ИмяПланаОбмена);
	
КонецФункции

#Область ДляВызоваИзДругихПодсистем

// ТехнологияСервиса.ОбменДаннымиВМоделиСервиса
...
Функция УзелПланаОбменаПоКоду(ИмяПланаОбмена, КодУзла) Экспорт
	...
	Возврат ОбменДаннымиПовтИсп.НайтиУзелПланаОбменаПоКоду(ИмяПланаОбмена, КодУзла);
...
Функция ВариантНастройкиОбменаДляКорреспондента(ИмяПланаОбмена, ИмяКорреспондента) Экспорт
	...
	ОписанияВариантовНастроекОбмена = ЗначениеНастройкиПланаОбмена(ИмяПланаОбмена, "ОписанияВариантовНастроекОбмена");
	ОписаниеВарианта = ОписанияВариантовНастроекОбмена.Найти(ИмяКорреспондента, "ИмяКорреспондента");
	
	ВариантНастройкиОбмена = ?(ЗначениеЗаполнено(ОписаниеВарианта), ОписаниеВарианта.ИдентификаторНастройки, "");
	Возврат ВариантНастройкиОбмена;
	
КонецФункции

// Конец ТехнологияСервиса.ОбменДаннымиВМоделиСервиса
...
// Для несуществующих параметров возвращается Неопределено.
// 
// Параметры:
...
Функция ЗначениеНастройкиПланаОбмена(ИмяПланаОбмена, ИмяПараметра, ИдентификаторНастройки = "") Экспорт
	...
	Если ОбменДаннымиПовтИсп.ПланыОбменаБСП().Найти(ИмяПланаОбмена) <> Неопределено И Ложь Тогда
	...
	Если СтрНайти(ИмяПараметра, ",") = 0 Тогда
		...
		ПараметрыПоУмолчанию.Свойство(ИмяПараметра, ЗначениеПараметра);
...
// См. ИнтеграцияСтандартныхПодсистем.ПриРегистрацииМенеджеровВнешнихМодулей.
...
Процедура ПриПродолженииНастройкиПодчиненногоУзлаРИБ() Экспорт
	...
	ИнтеграцияСтандартныхПодсистем.ПриНастройкеПодчиненногоУзлаРИБ();
...
Функция ШаблонИмениФайлаСообщения(ТекущийУзелПланаОбмена, УзелИнформационнойБазы, ЭтоИсходящееСообщение, Транслитерация = Ложь)
	...
	Возврат ИмяФайлаСообщенияОбмена(КодОтправителя, КодПолучателя);
...
//                                                                         Используется для создания заготовленных
...
//      * ОписанияВариантовНастроекОбмена                       - ТаблицаЗначений - определяет порядок использования вариантов
//                                                                         настроек обмена в зависимости от вида корреспондента:
//                                                                         *ИдентификаторНастройки - Строка - выбирается из
//                                                                         перечня, заданного в ВариантыНастроекОбмена.
//                                                                         *ИмяКорреспондента - Строка - выбирается исходя из
//                                                                         значения, заданного в функции ИмяКонфигурацииИсточника
//                                                                         модуля менеджера плана обмена на стороне корреспондента.
//                                                                         В случае, если параметр не заполнен, функциональность
//                                                                         вариантов настроек плана обмена при настройке
//                                                                         синхронизации с другим приложением в сервисе
//                                                                         не используется.
//
Функция НастройкиПланаОбменаПоУмолчанию(ИмяПланаОбмена)
	...
	ОписанияВариантовНастроекОбмена = Новый ТаблицаЗначений;
	ОписаниеТиповСтрока = Новый ОписаниеТипов("Строка");
	ОписанияВариантовНастроекОбмена.Колонки.Добавить("ИдентификаторНастройки", ОписаниеТиповСтрока);
	ОписанияВариантовНастроекОбмена.Колонки.Добавить("ИмяКорреспондента",      ОписаниеТиповСтрока);
	Параметры.Вставить("ОписанияВариантовНастроекОбмена", ОписанияВариантовНастроекОбмена);
