...
Функция ПолучитьОбработчикиИнтерфейсовОтправляемыхСообщений() Экспорт
	...
	ИнтеграцияСтандартныхПодсистем.РегистрацияИнтерфейсовОтправляемыхСообщений(МассивОбработчиков);
...
Функция ПолучитьОбработчикиИнтерфейсовПринимаемыхСообщений() Экспорт
	...
	ИнтеграцияСтандартныхПодсистем.РегистрацияИнтерфейсовПринимаемыхСообщений(МассивОбработчиков);
