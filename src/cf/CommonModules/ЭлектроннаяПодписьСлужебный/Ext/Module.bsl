...
// Определяет доступность электронной подписи для файла по его типу
Функция ДоступнаЭлектроннаяПодпись(ТипФайла) Экспорт
	
	Возврат Метаданные.ОпределяемыеТипы.ПодписанныйОбъект.Тип.СодержитТип(ТипФайла);
...
Процедура ЗарегистрироватьПодписаниеДанныхВЖурнале(ЭлементДанных, ОписаниеОшибки = "") Экспорт
	...
	СообщениеЖурналаРегистрации = СведенияОПодписиДляЖурналаРегистрации(
		ЭлементДанных.СвойстваПодписи.ДатаПодписи,
