...
Функция СписокТомовДисков() Экспорт
	...
	СписокТомовДисков = Новый СписокЗначений;
	
	СписокТомовДисков.Добавить("A");
	СписокТомовДисков.Добавить("B");
	СписокТомовДисков.Добавить("C");
	СписокТомовДисков.Добавить("D");
	СписокТомовДисков.Добавить("E");
	СписокТомовДисков.Добавить("F");
	СписокТомовДисков.Добавить("G");
	СписокТомовДисков.Добавить("H");
	СписокТомовДисков.Добавить("I");
	СписокТомовДисков.Добавить("J");
	СписокТомовДисков.Добавить("K");
	СписокТомовДисков.Добавить("L");
	СписокТомовДисков.Добавить("M");
	СписокТомовДисков.Добавить("N");
	СписокТомовДисков.Добавить("O");
	СписокТомовДисков.Добавить("P");
	СписокТомовДисков.Добавить("Q");
	СписокТомовДисков.Добавить("R");
	СписокТомовДисков.Добавить("S");
	СписокТомовДисков.Добавить("T");
	СписокТомовДисков.Добавить("U");
	СписокТомовДисков.Добавить("V");
	СписокТомовДисков.Добавить("W");
	СписокТомовДисков.Добавить("X");
	СписокТомовДисков.Добавить("Y");
	СписокТомовДисков.Добавить("Z");
	
	Возврат СписокТомовДисков;
