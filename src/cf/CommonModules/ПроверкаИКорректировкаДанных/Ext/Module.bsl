...
Функция ТабличныйДокументИзПрисоединенногоФайла(ПрисоединенныйФайл) Экспорт
	...
	ДвоичныеДанные = Модуль("ПрисоединенныеФайлы").ПолучитьДвоичныеДанныеФайла(ПрисоединенныйФайл);
...
Функция ЗаписатьИсторию(Проверка, РезультатПроверки)
	...
	Если РезультатПроверки.ТабличныйДокумент <> Неопределено Тогда
		...
		ПрисоединенныйФайл = Модуль("ПрисоединенныеФайлы").ДобавитьПрисоединенныйФайл(ПараметрыФайла, АдресФайла);
