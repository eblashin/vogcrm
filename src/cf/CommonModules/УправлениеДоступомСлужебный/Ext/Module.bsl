...
// См. ИнтеграцияСтандартныхПодсистем.ПослеЗаписиАдминистратораПриАвторизации.
...
// См. ИнтеграцияСтандартныхПодсистем.ПослеУстановкиПользователяИБ.
...
// См. ИнтеграцияСтандартныхПодсистем.ПриОпределенииТекстаВопросаПередЗаписьюПервогоАдминистратора.
...
// См. ИнтеграцияСтандартныхПодсистем.ПриСозданииАдминистратора.
...
// См. ИнтеграцияСтандартныхПодсистем.ПослеДобавленияИзмененияПользователяИлиГруппы.
...
// См. ИнтеграцияСтандартныхПодсистем.ПослеОбновленияСоставовГруппПользователей.
...
// См. ИнтеграцияСтандартныхПодсистем.ПослеИзмененияОбъектаАвторизацииВнешнегоПользователя.
...
Процедура ПриКопированииПравНовомуПользователю(Источник, Приемник) Экспорт
	...
	|	Справочник.ГруппыДоступа.Пользователи КАК ГруппыДоступаПользователи
	|ГДЕ
	|	НЕ(ГруппыДоступаПользователи.Пользователь <> &Пользователь
	|				И НЕ ГруппыДоступаПользователи.Пользователь В
	|						(ВЫБРАТЬ
...
Функция ВидДоступаИспользуется(Знач ВидДоступа) Экспорт
	...
	ИнтеграцияСтандартныхПодсистем.ПриЗаполненииИспользованияВидаДоступа(СвойстваВидаДоступа.Имя, Используется);
...
//      описание которых см. в комментарии к функции СвойстваВидовДоступа
//      в модуле менеджера константы ПараметрыОграниченияДоступа.
//
...
Функция СвойстваВидовДоступа()
	...
	ИнтеграцияСтандартныхПодсистем.ПриЗаполненииВидовДоступа(ВидыДоступа);
