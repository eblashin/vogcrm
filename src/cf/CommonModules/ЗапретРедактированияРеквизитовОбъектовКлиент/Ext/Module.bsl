...
Процедура ЗаполнитьСписокРазрешенныхКРедактированию(Знач Форма, МассивРеквизитов) Экспорт
	
	Для Каждого РазблокированныйРеквизит Из МассивРеквизитов Цикл
		
		Если Форма.Объект.Свойство(РазблокированныйРеквизит) Тогда
			
			ПредставлениеРеквизита = Форма.Объект[РазблокированныйРеквизит];
			Форма.РазрешеныКРедактированию.Добавить(РазблокированныйРеквизит, ПредставлениеРеквизита);
			
			Продолжить;
			
		КонецЕсли;
		
		Если Форма.Элементы.Найти(РазблокированныйРеквизит) <> Неопределено Тогда
		
			ПредставлениеРеквизита = Форма[РазблокированныйРеквизит];
			Форма.РазрешеныКРедактированию.Добавить(РазблокированныйРеквизит, ПредставлениеРеквизита);
