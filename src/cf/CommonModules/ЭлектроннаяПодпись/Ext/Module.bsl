...
Функция СертификатыШифрования(Объект) Экспорт
	...
	ПроверитьПараметрОбъект(Объект, "ЭлектроннаяПодпись.СертификатыШифрования", Ложь, Истина);
...
Процедура ПроверитьПараметрОбъект(Объект, ИмяПроцедуры, РегистрПодписей = Истина, ТолькоСсылки = Ложь)
	
	ОбщегоНазначенияКлиентСервер.ПроверитьПараметр(ИмяПроцедуры, "Объект", Объект,
		ЭлектроннаяПодписьСлужебныйПовтИсп.ТипыВладельцев(РегистрПодписей, ТолькоСсылки));
