...
Функция ЗагрузитьСообщения(Знач УчетнаяЗапись,
	...
	ИначеЕсли Не РежимТестирования Тогда
		...
		НаборПисем = CRM_РаботаСПочтовымиСообщениями.ИнтернетПочтаПолучитьСообщенияССервера(Соединение, ПараметрыЗагрузки, Ложь, ЗаголовкиИдентификаторы, НаборСообщенийДляУдаления);
		// -CRM
