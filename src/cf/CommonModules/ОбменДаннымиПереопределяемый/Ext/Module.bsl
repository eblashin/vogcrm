...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	// +CRM не переносить в объединенные решения
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.CRM_Полный);
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат);
	// -CRM не переносить в объединенные решения
	
	//СК++
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.вогОбменСУчетнойСистемой);
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.скMSExchange_ОбменПочтовымиСообщениями);
	//СК--
