...
#КонецЕсли
	...
	ИнтеграцияСтандартныхПодсистемКлиент.ПередЗавершениемРаботыСистемы(Отказ, Предупреждения);
...
Функция ИнформацияДляПоддержки() Экспорт
	...
	Текст = НСтр("ru = 'Название программы: [НазваниеПрограммы] 
                  ...
                  |Конфигурация изменена: [КонфигурацияИзменена]
                  |'");
...
Процедура ДействияПередНачаломРаботыСистемыВИнтеграционнойПроцедуре(Неопределен, Параметры) Экспорт
	...
	Попытка
		...
		ИнтеграцияСтандартныхПодсистемКлиент.ПередНачаломРаботыСистемы(Параметры);
...
Процедура ДействияПриНачалеРаботыСистемыВИнтеграционнойПроцедуре(Неопределен, Параметры) Экспорт
	...
	Попытка
		Параметры.Вставить("Модули", Новый Массив);
		ИнтеграцияСтандартныхПодсистемКлиент.ПриНачалеРаботыСистемы(Параметры);
		Параметры.Вставить("ДобавленныеМодули", Параметры.Модули);
		Параметры.Удалить("Модули");
	Исключение
...
Процедура ДействияПриНачалеРаботыСистемыПослеВсехПроцедур(Неопределен, Параметры) Экспорт
	...
	Попытка
		ИнтеграцияСтандартныхПодсистемКлиент.ПослеНачалаРаботыСистемы();
...
Функция ОбработатьПараметрыЗапуска()
	...
	Отказ = Ложь;
	ИнтеграцияСтандартныхПодсистемКлиент.ПриОбработкеПараметровЗапуска(ПараметрыЗапуска, Отказ);
