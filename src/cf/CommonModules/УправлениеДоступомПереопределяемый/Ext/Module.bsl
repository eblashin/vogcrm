...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	// { VOG RMV 2019-03-07 task 231
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "ВариантыОпросов";
	ВидДоступа.Представление = НСтр("ru = 'Вариант опроса'");
	ВидДоступа.ТипЗначений   = Тип("ПланВидовХарактеристикСсылка.вогВариантыОпросов");	
	// } VOG RMV 2019-03-07 task 231	
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// +CRM
	CRM_УправлениеДоступомСервер.ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления);
	// -CRM
...
Процедура ПриЗаполненииИспользованияВидаДоступа(ВидДоступа, Использование) Экспорт
	...
	// { VOG RMV 2019-03-07 task 231
	Если ВидДоступа = "ВариантыОпросов" Тогда
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	// { VOG RMV 2019-03-07 task 231
	Описание = Описание + "
	|Документ.вогАнкета.Чтение.ВариантыОпросов
	|Документ.вогАнкета.Изменение.ВариантыОпросов
	|";
	// } VOG RMV 2019-03-07 task 231
