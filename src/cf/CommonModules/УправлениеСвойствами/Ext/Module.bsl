...
Процедура ПриСозданииНаСервере(Форма, ДополнительныеПараметры = Неопределено) Экспорт
	...
	//+вог
	Если ДополнительныеПараметры.Свойство("НеСоздаватьОписаниеДополнительныхРеквизитов") Тогда
		Контекст.Вставить("НеСоздаватьОписаниеДополнительныхРеквизитов");
	КонецЕсли;
	//-вог
	...
	Если Контекст.ПроизвольныйОбъект Тогда
		...
		СоздатьОписаниеДополнительныхРеквизитов = Истина И Не Контекст.Свойство("НеСоздаватьОписаниеДополнительныхРеквизитов");
		//-вог
	Иначе
...
Процедура ЗаполнитьДополнительныеРеквизитыВФорме(Форма, Объект = Неопределено, ПоляНадписей = Ложь, СкрытьУдаленные = Неопределено) Экспорт
	...
	//+вог
	вогУправлениеСвойствами.ПослеПолученияОписанияСвойств(Форма, ОписаниеОбъекта, ОписаниеСвойств);
	//-вог
...
Процедура СоздатьОсновныеОбъектыФормы(Форма, Контекст, СоздатьОписаниеДополнительныхРеквизитов)
	...
	Если ОпцияИспользоватьСвойства Тогда
		...
		Форма.Свойства_ИспользоватьДопРеквизиты = СоздатьОписаниеДополнительныхРеквизитов ИЛИ Контекст.Свойство("НеСоздаватьОписаниеДополнительныхРеквизитов");
		//-вог
	КонецЕсли;
