...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение значения нового реквизита ""Вид переключателя"" плана видов характеристик ""Вопросы для анкетирования"".
		|До завершения обработки ""Вид переключателя"" в данном плане видов характеристик будет отображаться некорректно.'");
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.ОчередьОтложеннойОбработки = 1;
