...
//                              в разные подсистемы. См. пример ИнтеграцияСтандартныхПодсистемКлиент.ПередНачаломРаботыСистемы.
//
// Пример:
...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	// +CRM
	CRM_ОбновлениеИнформационнойБазыКлиент.ПередНачаломРаботыСистемы(Параметры);
	// -CRM
	
	//+вог
	//+Рабочий стол
	// +++ VOG Кулаков П.Л. 09.02.2021 DEV-79
	//скРабочийСтолКлиент.ПередНачаломРаботыСистемы();
	вогНачальнаяСтраницаПользователяКлиетСервер.ПередНачаломРаботыСистемы();
	// --- VOG Кулаков П.Л.
	//-Рабочий стол
	//-вог
...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	// +CRM
	CRM_ОбщегоНазначенияКлиент.ПриНачалеРаботыСистемы();
	...
	//+РабочийСтол 
	// +++ VOG Кулаков П.Л. 09.02.2021 DEV-79
	//скРабочийСтолКлиент.ПриНачалеРаботыСистемы();
	вогНачальнаяСтраницаПользователяКлиетСервер.ПриНачалеРаботыСистемы();
	// --- VOG Кулаков П.Л.
	//-РабочийСтол
	//-вог
...
Процедура ПослеНачалаРаботыСистемы() Экспорт
	...
	// +CRM
	CRM_ОбновлениеИнформационнойБазыКлиент.ПослеНачалаРаботыСистемы();
	// -CRM
...
//  ТекущийПроект в процедуре ОбщегоНазначенияПереопределяемый.ПараметрыРаботыКлиента и вписать следующий код:
//
