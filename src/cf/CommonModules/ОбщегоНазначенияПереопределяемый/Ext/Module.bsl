...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	//--> VOG Бей  22.05.2018 16:50:26 ID заявки:000001880
	Обработчики.Вставить("вогПодчиненныеСотрудники", "вогУправлениеДоступом.УстановкаПараметровСеанса");
	Обработчики.Вставить("вогДолжностныеПозиции", "вогУправлениеДоступом.УстановкаПараметровСеанса");
	//<-- VOG Бей  22.05.2018 16:50:37 ID заявки:000001880
	// + Тищенко В.В. RLS CRM_ЧтениеКлассификаторов. Установка параметров сеанса
	Обработчики.Вставить("CRM_ИспользуемаяАналитикаКлассификаторов", "вогУправлениеДоступом.УстановкаПараметровСеанса");
	// - Тищенко В.В.
	
	//++ VOG Ульянов И.В. 15.01.2020 CRM-121
	Обработчики.Вставить("вогСотрудникиДелегированиеПравМероприятия", "вогУправлениеДоступом.УстановкаПараметровСеанса");
	//-- VOG Ульянов И.В. 15.01.2020 CRM-121
	
	// +++ VOG Кулаков П.Л. 05.03.2020 CRM-385
	Обработчики.Вставить("вогРолиИсполнителя", "вогУправлениеДоступом.УстановкаПараметровСеанса");
	Обработчики.Вставить("вогОсновныеОбъектыАдресации", "вогУправлениеДоступом.УстановкаПараметровСеанса");
	// --- VOG Кулаков П.Л.
...
Процедура ПараметрыРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	//+вог
	//+Рабочий стол
	скРабочийСтолСервер.ПараметрыРаботыКлиентаПриЗапуске(Параметры);	
	//-Рабочий стол
	//-вог
