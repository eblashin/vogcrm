...
Функция ЭтоРазделенныйОбъектМетаданных(Знач ПолноеИмяОбъектаМетаданных, Знач Разделитель = Неопределено) Экспорт
	...
	Если Разделитель = Неопределено Тогда
		РазделениеПоОсновномуРеквизиту = РаботаВМоделиСервиса.РазделенныеОбъектыМетаданных(РазделительОсновныхДанных());
		РазделениеПоВспомогательномуРеквизиту = РаботаВМоделиСервиса.РазделенныеОбъектыМетаданных(РазделительВспомогательныхДанных());
...
Функция ПолучитьМодельДанныхОбласти() Экспорт
	...
	РазделительОсновныхДанных = РазделительОсновныхДанных();
	...
	РазделительВспомогательныхДанных = РазделительВспомогательныхДанных();
