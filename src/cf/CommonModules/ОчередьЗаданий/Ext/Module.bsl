...
Функция ПолучитьЗадания(Знач Отбор) Экспорт
	...
	РазделительЗаданийОбластейДанных = РаботаВМоделиСервисаПовтИсп.РазделительВспомогательныхДанных();
	...
	Для Каждого СправочникЗаданий Из СправочникиЗаданий Цикл
		...
		Если РаботаВМоделиСервисаПовтИсп.ЭтоРазделеннаяКонфигурация() И РаботаВМоделиСервиса.ЭтоРазделенныйОбъектМетаданных(ИмяСправочника, РаботаВМоделиСервисаПовтИсп.РазделительВспомогательныхДанных()) Тогда
...
Функция ДобавитьЗадание(ПараметрыЗадания) Экспорт
	...
	Для каждого ОписаниеПараметра Из ОчередьЗаданийСлужебныйПовтИсп.ПараметрыЗаданийОчереди() Цикл
		Если ПараметрыЗадания.Свойство(ОписаниеПараметра.Имя) Тогда
			Если ОписаниеПараметра.РазделениеДанных Тогда
				Если Не РаботаВМоделиСервисаПовтИсп.ЭтоРазделеннаяКонфигурация() ИЛИ Не РаботаВМоделиСервиса.ЭтоРазделенныйОбъектМетаданных(Задание.Метаданные(), РаботаВМоделиСервисаПовтИсп.РазделительВспомогательныхДанных()) Тогда
					Продолжить;
				КонецЕсли;
			КонецЕсли;
...
Процедура ИзменитьЗадание(Идентификатор, ПараметрыЗадания) Экспорт
	...
	Если РаботаВМоделиСервисаПовтИсп.ЭтоРазделеннаяКонфигурация() И РаботаВМоделиСервиса.ЭтоРазделенныйОбъектМетаданных(
				...
				РаботаВМоделиСервисаПовтИсп.РазделительВспомогательныхДанных()) Тогда
...
Функция ШаблоныЗаданийОчереди() Экспорт
	...
	ИнтеграцияСтандартныхПодсистем.ПриПолученииСпискаШаблонов(Шаблоны);
...
Процедура ПроверитьПараметрыЗадания(Параметры, Режим)
	...
	// Область данных
	Если РаботаВМоделиСервисаПовтИсп.РазделениеВключено()
		И РаботаВМоделиСервисаПовтИсп.ДоступноИспользованиеРазделенныхДанных() Тогда
