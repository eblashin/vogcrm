...
Процедура НастройкаИнтерфейса(НастройкиРаботыИнтерфейса) Экспорт
	...
	CRM_ДатыЗапретаИзменения.НастройкаИнтерфейса(НастройкиРаботыИнтерфейса);
	// -CRM не переносить в объединенные решения
КонецПроцедуры
...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	//+++ Терпогосян Д.Б. [06.08.2021 16:13:08] № DEV-743
	Раздел = Разделы.Добавить();
	Раздел.Имя  = "ВОГ_ДокументыПланирования";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("b3d2f7d9-f6b8-11eb-80fe-005056bc3fe8");
	Раздел.Представление = НСтр("ru = 'ВОГ Документы планирования'");
	Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.СтруктураПредприятия"));
	
	//--- Терпогосян Д.Б. [06.08.2021 16:13:17] № DEV-743 
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	//+++ Терпогосян Д.Б. [06.08.2021 16:19:16] №  DEV-743
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	"Документ.ПланированиеПродажПлитка",		"ПериодПланирования",	"ВОГ_ДокументыПланирования",	"Подразделение");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	"Документ.ПланированиеПродажПоПотенциальнымТорговымТочкамОбои",		"ПериодПланирования",	"ВОГ_ДокументыПланирования",	"Подразделение");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	"Документ.ПланированиеПродажПоПотенциальнымТорговымТочкамПлитка",		"ПериодПланирования",	"ВОГ_ДокументыПланирования",	"Подразделение");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	"Документ.КонструкторМаршрутов",		"ПериодПланирования",	"ВОГ_ДокументыПланирования",	"Подразделение");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	"Документ.ПланированиеПродажОбои",		"ПериодПланирования",	"ВОГ_ДокументыПланирования",	"Подразделение");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	"Документ.вогРаспределениеDIYПоНоменклатурнымГруппам",		"ПериодПланирования",	"ВОГ_ДокументыПланирования",	"Подразделение");
	//--- Терпогосян Д.Б. [06.08.2021 16:19:16] №  DEV-743	
КонецПроцедуры
...
Процедура ПередПроверкойЗапретаИзменения(Объект,
	...
	// +CRM не переносить в объединенные решения
	CRM_ДатыЗапретаИзменения.ПередПроверкойЗапретаИзменения(
		Объект,
		ПроверкаЗапретаИзменения,
		УзелПроверкиЗапретаЗагрузки,
		ВерсияОбъекта);
	...
	//+++ Терпогосян Д.Б. [06.08.2021 16:48:10] № DEV-743
	...
	КонецЕсли;
	//--- Терпогосян Д.Б. [06.08.2021 16:48:11] № DEV-743 
