...
//
// Для работы процедуры у динамического списка должна установлена основная таблица и установлен
// произвольный запрос с синонимами для стандартных реквизитов, например, Дата и Номер у документов.
//
// Параметры:
