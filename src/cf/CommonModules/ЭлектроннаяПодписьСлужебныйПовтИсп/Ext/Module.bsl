...
Функция ТипыВладельцев(РегистрПодписей = Истина, ТолькоСсылки = Ложь) Экспорт
	
	МассивТипов = Новый Массив;
	Если РегистрПодписей Тогда
		Типы = Метаданные.РегистрыСведений.ЭлектронныеПодписи.Измерения.ПодписанныйОбъект.Тип.Типы();
	Иначе
		Типы = Метаданные.РегистрыСведений.СертификатыШифрования.Измерения.ЗашифрованныйОбъект.Тип.Типы();
	КонецЕсли;
	...
	Для Каждого Тип Из Типы Цикл
		...
		Если Не ТолькоСсылки Тогда
			...
			Если Метаданные.ВариантВстроенногоЯзыка = Метаданные.СвойстваОбъектов.ВариантВстроенногоЯзыка.Русский Тогда
				ИмяТипаОбъекта = СтрЗаменить(ПолноеИмя, ".", "Объект.");
			Иначе
				ИмяТипаОбъекта = СтрЗаменить(ПолноеИмя, ".", "Object.");
			КонецЕсли;
			МассивТипов.Добавить(Тип(ИмяТипаОбъекта));
		КонецЕсли;
	КонецЦикла;
