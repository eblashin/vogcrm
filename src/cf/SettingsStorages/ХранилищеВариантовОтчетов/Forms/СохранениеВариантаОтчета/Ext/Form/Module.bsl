...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// +++ VOG Кулаков П.Л. 12.11.2020 CRM-999
	УстановитьДоступностьКнопокВыбратьУбратьВсе();
	// --- VOG Кулаков П.Л.
...
// +++ VOG Кулаков П.Л. 12.11.2020 CRM-999
&НаСервере
Процедура УстановитьДоступностьКнопокВыбратьУбратьВсе()
	
	ДоступностьКнопок = ?(Доступен = "ТолькоДляАвтора", Ложь, Истина);
	Элементы.ПользователиВариантаУстановитьВсе.Доступность = ДоступностьКнопок;
	Элементы.ПользователиВариантаСнятьВсе.Доступность = ДоступностьКнопок;
...
// +++ VOG Кулаков П.Л. 10.11.2020 CRM-980
&НаКлиенте
Процедура УстановитьВсе(Команда)
	
	Для Каждого Элемент Из ПользователиВарианта Цикл
